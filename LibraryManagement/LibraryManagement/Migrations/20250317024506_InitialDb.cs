    ...
    public partial class InitialDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BorrowReceipts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BorrowReceipts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReturnHistories_BorrowReceipts_BorrowReceiptId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BorrowReceiptDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BorrowReceiptDetails_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BorrowReceiptDetails_BorrowReceipts_BorrowReceiptId",
                        column: x => x.BorrowReceiptId,
                        principalTable: "BorrowReceipts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Penalties_BorrowReceiptDetails_BorrowReceiptDetailId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowReceiptDetails_BorrowReceiptId",
                table: "BorrowReceiptDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Penalties_BorrowReceiptDetailId",
                table: "Penalties",
